...
<div class="container">
Hello <span class="font-weight-bold"><%=session.getAttribute("user") %> </span> , Here is your order details , <br><br>
...
Total Quantity : <%=count %><br>
Amount : <%=price %><br>
SGST : <%=price*(0.25) %><br>
CGST : <%=price*(0.25) %><br>
<p class="font-weight-bold">Total Amount After Tax : <%=price+(price*(0.5)) %><br>
</div>
<%


	//String phone = (String) session.getAttribute("phone");
/* 	String phone = "7041451645";
	String message = "Hello";
	String url = "https://www.fast2sms.com/dev/bulk";
	String apiKey = "ZImiXfz0jP1BzBEs9sBLbADB38vavNvU6BdJlQEkQljiTfxDW1MTwnsoreua";
    ...
    while ((inputLine = in.readLine()) != null) {
      ...
      // Print the response from the Fast2SMS API to the servlet console
      //System.out.println(responseBuffer.toString());
	
%>
<div class="text-center">
<a href="ProductController"><button class="btn btn-lg btn-primary">Go To Home Page</button></a>
</div>
